...
public class Update extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        final String drag1 = request.getParameter("drag1");
        final String drag2 = request.getParameter("drag2");
        final String drag3 = request.getParameter("drag3");
        final String drag4 = request.getParameter("drag4");
        final String target1 = request.getParameter("target1");
        final String target2 = request.getParameter("target2");
        final String target3 = request.getParameter("target3");
        final String target4 = request.getParameter("target4");
